...
Скористайтеся програмою **Raspberry Pi Imager** або будь-яким іншим інсталятором для запису образів на SD-карту.

> ⚠️ **Важливо:** Використовуйте [**Raspberry Pi Imager версії 1.9.6**](https://github.com/raspberrypi/rpi-imager/releases/tag/v1.9.6).
> Починаючи з версії 2.0, Raspberry Pi Imager більше не дозволяє налаштовувати користувацькі образи (Wi-Fi, SSH, ім'я користувача).
> Це свідоме рішення команди Raspberry Pi — вони вважають таке налаштування для користувацьких образів непідтримуваним.
