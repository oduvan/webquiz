...
Окрім питань з вибором, WebQuiz підтримує питання з текстовою відповіддю, де студент вводить текст у поле.
...
- **type: "text"** — обов'язково вказує, що це текстове питання
- **question** — текст питання
