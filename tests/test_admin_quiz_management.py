...
def test_admin_create_quiz_wizard_mode(temp_dir):
    ...
    with custom_webquiz_server() as (proc, port):
        quiz_data = {
            ...
            "questions": [
                {"question": "What is 5 + 3?", "options": ["6", "7", "8", "9"], "correct_answer": 2},
                {"question": "What is 10 - 4?", "options": ["5", "6", "7", "8"], "correct_answer": 1},
            ],
        }
...
def test_admin_get_quiz_content(temp_dir):
    ...
    quiz_data = {
        ...
        "questions": [
            {"question": "Capital of France?", "options": ["London", "Paris", "Berlin", "Madrid"], "correct_answer": 1}
        ],
    }
...
def test_admin_update_quiz_text_mode(temp_dir):
    ...
    original_quiz = {
        ...
        "questions": [{"question": "Before update?", "options": ["A", "B"], "correct_answer": 0}],
    }
...
def test_admin_delete_quiz(temp_dir):
    ...
    quiz_to_delete = {
        "delete_me.yaml": {
            ...
            "questions": [{"question": "Will be deleted?", "options": ["Yes", "No"], "correct_answer": 0}],
        },
        "keep_me.yaml": {
            "title": "Quiz to Keep",
            "questions": [{"question": "Will stay?", "options": ["Yes", "No"], "correct_answer": 0}],
        },
    }
...
def test_admin_delete_active_quiz(temp_dir):
    ...
    active_quiz = {
        "active_quiz.yaml": {
            "title": "Active Quiz",
            "questions": [{"question": "Am I active?", "options": ["Yes", "No"], "correct_answer": 0}],
        }
    }
...
def test_update_active_quiz_affects_server_state(temp_dir):
    ...
    original_quiz = {
        ...
        "questions": [{"question": "Original active question?", "options": ["A", "B"], "correct_answer": 0}],
    }
    ...
    with custom_webquiz_server(quizzes=quizzes) as (proc, port):
        ...
        updated_quiz_data = {
            ...
            "questions": [
                {"question": "Updated active question?", "options": ["X", "Y", "Z", "W"], "correct_answer": 2}
            ],
        }
...
def test_create_then_switch_to_new_quiz(temp_dir):
    ...
    with custom_webquiz_server() as (proc, port):
        ...
        quiz_data = {
            ...
            "questions": [{"question": "Switch to me?", "options": ["Yes", "No"], "correct_answer": 0}],
        }
